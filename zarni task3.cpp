...
int main() {
    ...
    root = insert(root, 200, "Surgical Masks");
    root = insert(root, 150,  "Scalpels");
    root = insert(root, 250, "Vaccine Vials");
    root = insert(root, -10,  "Corrupted Data"); // Tests error handling
    root = insert(root, 200, "Duplicate Masks"); // Tests duplicate handling

    cout << "\n--- SEARCHING INVENTORY ---" << endl;
    searchItem(root, 250);
    searchItem(root, 888); // Tests missing item
