...
int main() {
    ...
    root = insert(root, 100, "Smartphone");
    root = insert(root, 50,  "Laptop");
    root = insert(root, 150, "Headphones");
    root = insert(root, -5,  "Corrupted Data"); // Tests error handling
    root = insert(root, 100, "Duplicate Phone"); // Tests duplicate handling

    cout << "\n--- SEARCHING INVENTORY ---" << endl;
    searchItem(root, 50);
    searchItem(root, 999); // Tests missing item
